...
writer = csv.writer(open("../files/dataset_2.1.csv", 'w'))

writer.writerow(['date', 'corn_br', 'corn_usd', 'dolar', 'corn_br-1', 'corn_br-2', 'corn_br-3', 'max_corn_br-1', 'min_corn_br-1', 'open_corn_br-1', 'var_corn_br-1', 'vol_corn_br-1', 'br_production_1_before', 'br_plateau_area_1_before', 'br_productivity_1_before']) 
