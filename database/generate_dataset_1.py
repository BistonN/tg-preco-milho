...
for item in server.db_select('historical_data', _query= query):
    ...
    if corn_br and corn_usd and dolar:
        ...
        for one_day_before in server.db_select('historical_data', _query={"date": date_corn_one_day_before}):
        ...
        # for two_days_before in server.db_select('historical_data', _query={"date": date_corn_two_days_before}):
        ...
        # for three_days_before in server.db_select('historical_data', _query={"date": date_corn_three_days_before}):
