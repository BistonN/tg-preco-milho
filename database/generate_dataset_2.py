    ...
    if corn_1_before.get(key) == 0 or corn_1_before.get(key) == '' or corn_1_before.get(key) == None:
        ...
        if corn_2_before.get(key) == 0 or corn_2_before.get(key) == '' or corn_2_before.get(key) == None:
            ...
            if corn_3_before.get(key) == 0 or corn_3_before.get(key) == '' or corn_3_before.get(key) == None:
                results = 0
        return results
    return corn_1_before.get(key)


writer = csv.writer(open("../files/dataset_biston.csv", 'w'))

writer.writerow(['date', 'corn_br', 'corn_br-1', 'corn_br-2', 'corn_br-3', 'max_corn_br-1', 'min_corn_br-1', 'open_corn_br-1', 'var_corn_br-1', 'vol_corn_br-1']) 
            ...
            if day != 0:
                ...
                if results:
                    if results.get('corn_br'): 
                        ...
                        writer.writerow([results.get('date'), results.get('corn_br'), corn_1_before.get('corn_br'), corn_2_before.get('corn_br'), corn_3_before.get('corn_br'), max_corn_br_1_before, min_corn_br_1_before, open_corn_br_1_before, var_corn_br_1_before, vol_corn_br_1_before]) 
