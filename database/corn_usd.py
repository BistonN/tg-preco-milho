...
with open('../files/milho_usd_semanal.csv', 'r') as arquivo_csv:
    ...
    for idx, colunm in enumerate(reader):
        if idx > 1:
            ...
            values = [utils.string_to_date(colunm[0]), utils.string_to_float(colunm[1]), utils.string_to_float(colunm[2]), utils.string_to_float(colunm[3]), utils.string_to_float(colunm[4]), utils.string_to_float(colunm[5]), utils.string_to_float(colunm[6])]
